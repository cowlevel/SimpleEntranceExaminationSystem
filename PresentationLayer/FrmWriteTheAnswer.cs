...
{
    public partial class FrmWriteTheAnswer : Form
    {
        ...
        private void FrmWriteTheAnswer_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (InputsAreValid())
            {
                ...
                _question.CorrectAnswer = txtAnswer.Text;
        ...
        private bool InputsAreValid()
        {
            ...
            else if (string.IsNullOrWhiteSpace(txtAnswer.Text))
            {
                lblStatus.Text = "  Please enter answer";
                txtAnswer.Focus();
                return false;
            }
